...
public partial class MobileProfileSummary : VBoxContainer
{
	...
	public override void _Ready() { GetNode<Button>("Showcase/Overlay/Mode/TwoD").Pressed += () => SetMode(false); GetNode<Button>("Showcase/Overlay/Mode/ThreeD").Pressed += () => SetMode(true); }
